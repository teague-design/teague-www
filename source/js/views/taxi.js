...
export default ( view ) => {
    ...
    return `
        <div class="taxi__cats">
            ...
            <a class="taxi__cat js-taxi-cat h6 ac ${params.category ? "" : "is-active"}" href="${view.data.page}">All</a>
            ${cats.map(( cat ) => {
                return `<a class="taxi__cat js-taxi-cat h6 ac ${params.category === cat ? "is-active" : ""}" href="#${view.data.page}?category=${cat}" data-value="${cat}">${cat}</a>`;
